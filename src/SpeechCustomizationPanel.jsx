        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content" onClick={e => e.stopPropagation()} style={{ width: '500px', background: '#27272a', color: '#e4e4e7' }}>
                ...
                <div className="modal-body" style={{ maxHeight: '60vh', overflowY: 'auto' }}>
                    ...
                    <div>
                        <h4 style={{ margin: '0 0 10px 0', fontSize: '14px', color: '#e4e4e7', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span title="These rules apply to all spoken speech">Custom Skipping Rules</span>
                            <button className="icon-btn" onClick={onClose} style={{ width: '24px', height: '24px' }}><Icons.Close /></button>
                        </h4>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '13px', color: '#e4e4e7' }}>
                            ...
                            <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                                ...
                                />
                                Skip superscript citations (e.g. <sup>1, 2</sup>)
                            </label>
                        </div>
                    </div>
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        <h4 style={{ margin: '10px 0 10px 0', fontSize: '14px', color: '#e4e4e7' }}>Keyword skipping or custom Pronunciation</h4>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '10px' }}>
                                {customPronunciations.map((rule, index) => (
                                    <div key={index} style={{ display: 'flex', alignItems: 'center', gap: '5px', flexWrap: 'wrap', background: '#27272a', padding: '8px', borderRadius: '4px', border: '1px solid #3f3f46' }}>
                                        ...
                                        <input
                                            type="text"
                                            placeholder="spoken as... (leave blank to skip)"
                    ...
                    <div>
                        ...
                        <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer', fontSize: '13px', color: '#e4e4e7' }}>
                            ...
                            />
                            Dim out words that will be skipped or replaced.
                        </label>
                        {/* <div style={{ fontSize: '11px', color: '#a1a1aa', marginTop: '8px' }}>
